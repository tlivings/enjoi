...
module.exports = function enjoi(schema, options) {
    ...
    function number(current) {
        var joischema = Joi.number().options({ language: { number: { base: current.message } } });
    ...
    function regularString(current) {
        var joischema = Joi.string().options({ language: { any: { empty: current.message } } });
    ...
    function email(current) {
        var joischema = Joi.string().email().options({ language: { any: { empty: current.message } } });
    ...
    function date(current) {
        var joischema = Joi.date().options({ language: { date: { base: current.message } } });
