...
class SchemaResolver {
    ...
    date(schema) {
        let joischema = this.joi.date();
        schema.minimum && (joischema = joischema.min(schema.minimum));
        schema.maximum && (joischema = joischema.max(schema.maximum));
        return joischema;
    }
