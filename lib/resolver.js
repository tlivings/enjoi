...
class SchemaResolver {
    ...
    string(schema) {
        ...
        switch (schema.format) {
            case 'date':
                return joischema.regex(/^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])$/, 'JsonSchema date format');
            case 'time':
                return joischema.regex(/^([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i, 'JsonSchema time format');
            case 'date-time':
                return joischema.regex(/^(\d{4})-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9]|60)(Z|(\+|-)([01][0-9]|2[0-3]):([0-5][0-9]))$/i, 'JsonSchema date-time format');
            case 'binary':
                return this.binary(schema);
            case 'email':
            ...
            case 'byte':
                ...
                break;
            case 'uuid':
                joischema = joischema.guid({ version: ['uuidv4'] });
                break
            case 'guid':
                joischema = joischema.guid();
                break;
        }
